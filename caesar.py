...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--method", help="Option to specify encoding/decoding in extended or normal or custom modes default is normal")
    ...
    if args.encode:
        if args.key:
            ...
            print("Secret: " + caesar(args.encode, int(input("Enter an Integer Key(0-25): ")),mode = "encrypt",method=method))
    if args.decode:
        if args.key:
